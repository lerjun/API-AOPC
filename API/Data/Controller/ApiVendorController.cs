        ...
        public IActionResult SaveVendor(VendorModel data)
        {
            ...
            try
            {
                ...
                if (data.VendorName.Length != 0 || data.Description.Length != 0 )
                {
                    ...
                    if (data.Id == 0)
                    {
                        string sql = $@"select * from tbl_VendorModel where VendorName='" + data.VendorName + "'";
            ...
            try
            {
                ...
                for (int i = 0; i < list.Count; i++)
                {
                    ...
                    if (dt.Rows.Count == 0)
                    {
                        ...
                        {
                            FeaturedImage = "https://www.alfardanoysterprivilegeclub.com/assets/img/" + list[i].FeatureImg;
                        }
                        ...
                        {
                            Logo = "https://www.alfardanoysterprivilegeclub.com/assets/img/" + list[i].VendorLogo;
                        }
